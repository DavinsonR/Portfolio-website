...
export const about = {
  es: {
      ...
      rows: [
        {
          ...
          desc: "Dueño, desde HQ, del cierre y el forecast de SG&A de más de 15 países a la vez — América y el hemisferio oriental. Variaciones contra plan, contra forecast previo y en moneda constante. 100% remoto, desde el primer día.",
          tag: "FP&A",
        },
        {
          period: "2024 — 2026",
          title: "SLB · dos ascensos en 26 meses",
          desc: "Tesorería y facturación LATAM, hasta liderar a un practicante. Detecté por iniciativa propia el descalce cambiario y lo modelé en Python, y construí una automatización que le devolvió ~10 horas al mes a cada analista — unas 60 al mes al equipo entero. Revenue recognition bajo SOX y auditorías internas sobre proyectos de tecnología.",
          tag: "Finanzas + datos",
        },
        {
          period: "2023",
          title: "Investigación económica · LEE Javeriana",
          desc: "Evaluación de impacto sobre datos de educación superior, con equipos remotos internacionales.",
          tag: "Datos",
        },
      ],
    },
    ...
    disclosures: {
      title: "Letra pequeña, a la vista",
      items: [
        {
    ...
    contact: {
      ...
      body: "Un solo contrato cubre el análisis financiero, el pipeline y el tablero. Finance Data Analyst, Analytics Engineer o FP&A con automatización. Bogotá, GMT-5, tu horario de EE. UU. completo. Respondo en menos de un día hábil, en español o en inglés.",
  ...
  en: {
      ...
      rows: [
        {
          period: "2026 — present",
          title: "Business Consultant, FP&A · Neoris EPAM",
          desc: "I own, from HQ, the SG&A close and forecast for 15+ countries at once — the Americas and the Eastern Hemisphere. Variance against plan, against prior forecast, and in constant currency. Fully remote, from day one.",
          tag: "FP&A",
        },
        {
          period: "2024 — 2026",
          title: "SLB · two promotions in 26 months",
          desc: "LATAM treasury and billing, up to leading an intern. I spotted the FX mismatch on my own initiative and modelled it in Python, and built automation that handed every analyst ~10 hours a month back — around 60 a month across the team. Revenue recognition under SOX, and internal audits on technology projects.",
          tag: "Finance + data",
        },
        {
          period: "2023",
          title: "Economic research · LEE Javeriana",
          desc: "Impact evaluation on higher-education data, with international remote teams.",
          tag: "Data",
        },
      ],
    },
    ...
    disclosures: {
      title: "The fine print, in plain sight",
      items: [
        {
